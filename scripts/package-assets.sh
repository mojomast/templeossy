#!/bin/bash
# package-assets.sh — Package BIOS/ROM files and TempleOS ISO for browser delivery
#
...
# ISO is placed at /pack/TempleOSCDV5.03.ISO (used with QEMU -cdrom flag)
#
...
#   - TempleOS ISO in assets/TempleOSCDV5.03.ISO
...
check_file "$PROJECT_ROOT/assets/TempleOSCDV5.03.ISO" "TempleOS ISO"
...
# Copy TempleOS ISO (QEMU -cdrom /pack/TempleOSCDV5.03.ISO)
cp "$PROJECT_ROOT/assets/TempleOSCDV5.03.ISO" "$STAGING_DIR/pack/"
