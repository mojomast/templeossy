  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/out/qemu-system-x86_64.data';
...
Module['FS_createPath']("/", "pack", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_/out/qemu-system-x86_64.data');

      };
      Module['addRunDependency']('datafile_/out/qemu-system-x86_64.data');
