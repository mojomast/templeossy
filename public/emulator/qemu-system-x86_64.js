...
var PTY_waitForReadableWithAtomicImpl = function(atomicIndex) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(25, 0, 0, atomicIndex);
...
function ___syscall_statfs64(path, size, buf) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(35, 0, 1, path, size, buf);
  path >>>= 0;
  size >>>= 0;
  buf >>>= 0;
  try {
...
function _fd_pread(fd, iov, iovcnt, offset, pnum) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(44, 0, 1, fd, iov, iovcnt, offset, pnum);
  iov >>>= 0;
  iovcnt >>>= 0;
  offset = bigintToI53Checked(offset);
  pnum >>>= 0;
...
var proxiedFunctionTable = [ _proc_exit, exitOnMainThread, pthreadCreateProxied, ___syscall_accept4, ___syscall_bind, ___syscall_chdir, ___syscall_connect, ___syscall_dup3, ___syscall_faccessat, ___syscall_fcntl64, ___syscall_fstat64, ___syscall_ftruncate64, ___syscall_getcwd, ___syscall_getdents64, ___syscall_getpeername, ___syscall_getsockname, ___syscall_getsockopt, ___syscall_ioctl, ___syscall_listen, ___syscall_lstat64, ___syscall_mkdirat, ___syscall_newfstatat, ___syscall_openat, ___syscall_pipe, xterm_pty_old_poll, PTY_waitForReadableWithAtomicImpl, ___syscall_readlinkat, ___syscall_recvfrom, ___syscall_recvmsg, ___syscall_renameat, ___syscall_rmdir, ___syscall_sendmsg, ___syscall_sendto, ___syscall_socket, ___syscall_stat64, ___syscall_statfs64, ___syscall_unlinkat, __mmap_js, __msync_js, __munmap_js, _environ_get, _environ_sizes_get, _fd_close, _fd_fdstat_get, _fd_pread, _fd_pwrite, xterm_pty_old_fd_read, _fd_seek, _fd_sync, _fd_write, _getaddrinfo ];
...
var _ntohs, _htonl, _htons, _qemu_setup_display, _qemu_display_data, _qemu_display_width, _qemu_display_height, _qemu_display_stride, _qemu_display_frame_count, _qemu_display_check_dirty, _qemu_input_send_key, _qemu_input_send_mouse, _qemu_input_send_mouse_abs, _malloc, _free, _main, _raise, _pthread_self, __emscripten_tls_init, _emscripten_builtin_memalign, __emscripten_proxy_main, __emscripten_thread_init, __emscripten_thread_crashed, __emscripten_run_on_main_thread_js, __emscripten_thread_free_data, __emscripten_thread_exit, __emscripten_check_mailbox, _setThrew, __emscripten_tempret_set, __emscripten_tempret_get, _emscripten_stack_set_limits, __emscripten_stack_restore, __emscripten_stack_alloc, _emscripten_stack_get_current, dynCall_v, dynCall_ji, dynCall_viii, dynCall_iiii, dynCall_ii, dynCall_vi, dynCall_vii, dynCall_iji, dynCall_viji, dynCall_vji, dynCall_ijiii, dynCall_iii, dynCall_viiii, dynCall_viiiii, dynCall_iiiii, dynCall_ij, dynCall_jiji, dynCall_vijji, dynCall_viid, dynCall_iiiiii, dynCall_iijiii, dynCall_iijjii, dynCall_iij, dynCall_iiiiiii, dynCall_viiiiiii, dynCall_ijiiii, dynCall_jii, dynCall_viijj, dynCall_iiji, dynCall_jiijj, dynCall_vijiii, dynCall_i, dynCall_vjiii, dynCall_viijii, dynCall_viiiijjii, dynCall_iijji, dynCall_iijj, dynCall_jijii, dynCall_iiiiiiii, dynCall_viiiiii, dynCall_viiiiiiii, dynCall_vij, dynCall_jiii, dynCall_iijiiiii, dynCall_iiij, dynCall_viij, dynCall_vj, dynCall_viiji, dynCall_viiijii, dynCall_viiiijii, dynCall_jjjji, dynCall_jijj, dynCall_vijjjj, dynCall_jij, dynCall_viijij, dynCall_viiij, dynCall_vijj, dynCall_jjj, dynCall_viiiiji, dynCall_iijiiiji, dynCall_vijii, dynCall_iijii, dynCall_viiiji, dynCall_j, dynCall_iiijj, dynCall_iiiiiiiii, dynCall_iiijjiii, dynCall_iijjiii, dynCall_iijiiii, dynCall_iijjiiii, dynCall_iiijijjii, dynCall_iiijiiiii, dynCall_vijjii, dynCall_iidiiii, _asyncify_start_unwind, _asyncify_stop_unwind, _asyncify_start_rewind, _asyncify_stop_rewind;

function assignWasmExports(wasmExports) {
  _ntohs = wasmExports["ntohs"];
  _htonl = wasmExports["htonl"];
  _htons = wasmExports["htons"];
  Module["_qemu_setup_display"] = _qemu_setup_display = wasmExports["qemu_setup_display"];
  Module["_qemu_display_data"] = _qemu_display_data = wasmExports["qemu_display_data"];
  Module["_qemu_display_width"] = _qemu_display_width = wasmExports["qemu_display_width"];
  Module["_qemu_display_height"] = _qemu_display_height = wasmExports["qemu_display_height"];
  Module["_qemu_display_stride"] = _qemu_display_stride = wasmExports["qemu_display_stride"];
  Module["_qemu_display_frame_count"] = _qemu_display_frame_count = wasmExports["qemu_display_frame_count"];
  Module["_qemu_display_check_dirty"] = _qemu_display_check_dirty = wasmExports["qemu_display_check_dirty"];
  Module["_qemu_input_send_key"] = _qemu_input_send_key = wasmExports["qemu_input_send_key"];
  Module["_qemu_input_send_mouse"] = _qemu_input_send_mouse = wasmExports["qemu_input_send_mouse"];
  Module["_qemu_input_send_mouse_abs"] = _qemu_input_send_mouse_abs = wasmExports["qemu_input_send_mouse_abs"];
